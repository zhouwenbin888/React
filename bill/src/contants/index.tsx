export interface BillItem {
  ...
  export const billTypeToName: { [key: string]: string } = Object.keys(billListData).reduce((prev, key) => {
    (billListData[key as keyof BillListData] as BillCategory[]).forEach(bill => {
      bill.list.forEach(item => {
        prev[item.type as keyof typeof prev] = item.name;
      });
    });
    return prev;
